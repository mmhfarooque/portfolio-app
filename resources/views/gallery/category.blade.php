<x-layouts.public>
    <x-slot name="title">{{ $category->name }} - {{ config('app.name', 'Photography Portfolio') }}</x-slot>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            @else
                <div class="text-center py-20">
                    ...
                    <h3 class="mt-4 text-xl font-medium text-gray-400">No photos in this category</h3>

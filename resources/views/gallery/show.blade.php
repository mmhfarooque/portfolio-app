                    ...
                    <div class="bg-theme-card border border-theme rounded-lg p-6">
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            ...
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('photos.show', $photo)) }}"
                               target="_blank"
                               class="flex items-center justify-center p-3 bg-[#1877F2] rounded-lg hover:opacity-90 transition"
                            ...
                            <a href="https://twitter.com/intent/tweet?url={{ urlencode(route('photos.show', $photo)) }}&text={{ urlencode($photo->title) }}"
                               target="_blank"
                               class="flex items-center justify-center p-3 bg-black rounded-lg hover:opacity-90 transition"
                            ...
                            <a href="https://pinterest.com/pin/create/button/?url={{ urlencode(route('photos.show', $photo)) }}&media={{ urlencode(url('storage/' . $photo->display_path)) }}&description={{ urlencode($photo->title) }}"
                               target="_blank"
                               class="flex items-center justify-center p-3 bg-[#E60023] rounded-lg hover:opacity-90 transition"
                            ...
                            <a href="https://api.whatsapp.com/send?text={{ urlencode($photo->title . ' - ' . route('photos.show', $photo)) }}"
                               target="_blank"
                               class="flex items-center justify-center p-3 bg-[#25D366] rounded-lg hover:opacity-90 transition"
                            ...
                            <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(route('photos.show', $photo)) }}"
                               target="_blank"
                               class="flex items-center justify-center p-3 bg-[#0A66C2] rounded-lg hover:opacity-90 transition"
                            ...
                            <a href="https://t.me/share/url?url={{ urlencode(route('photos.show', $photo)) }}&text={{ urlencode($photo->title) }}"
                               target="_blank"
                               class="flex items-center justify-center p-3 bg-[#0088CC] rounded-lg hover:opacity-90 transition"
                            ...
                            <a href="mailto:?subject={{ urlencode($photo->title) }}&body={{ urlencode('Check out this photo: ' . route('photos.show', $photo)) }}"
                               class="flex items-center justify-center p-3 bg-theme-tertiary rounded-lg hover:opacity-90 transition"
                            ...
                            <button onclick="copyLink()" id="copy-btn"
                                    class="flex items-center justify-center p-3 bg-theme-tertiary rounded-lg hover:opacity-90 transition"
                                    title="Copy Link">
                                <svg id="copy-icon" class="w-5 h-5 text-theme-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">

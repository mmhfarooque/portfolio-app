...
const form = useForm({
    ...
    affiliate_link: props.equipment.affiliate_link || '',
    image: null,
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Equipment</h2>
            </div>
        </template>
        ...
        <div class="py-6">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <form @submit.prevent="submit" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <!-- Current Image -->
                    <div v-if="equipment.image_path" class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- New Image -->
                        <div class="md:col-span-2">
                            <InputLabel for="image" value="New Image" />
                            <input
                                type="file"
                                id="image"

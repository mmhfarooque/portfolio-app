    ...
    <PublicLayout>
        ...
        <div class="relative">
            ...
            <div class="relative bg-black">
                ...
                <div class="absolute inset-0 pointer-events-none bg-gradient-to-t from-black/30 via-transparent to-black/10"></div>

                <!-- Engagement Buttons - Overlayed at bottom center -->
                <div class="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-3">
                    ...
                    <a
                        href="#comments"
                        class="flex items-center gap-2 px-4 py-2.5 rounded-full bg-black/50 backdrop-blur-md text-white hover:bg-black/70 transition-all duration-200 hover:scale-105"
                    >
        ...
        >
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <!-- Comments Section -->
                <div id="comments" class="mt-16 scroll-mt-8">
                    <CommentSection
                        :photo-slug="photo.slug"
